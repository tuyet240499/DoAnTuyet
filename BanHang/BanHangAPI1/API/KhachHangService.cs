...
namespace BanHangAPI1.API
{
    public class KhachHangService
    {
        ...
        public bool LuuKhachHang(DangKyModel dangKy)
        {
            bool result = true;
            ...
            khachHang.TenKhachHang = dangKy.TenKhachHang;
            khachHang.SDT = dangKy.SDT;
            khachHang.NgaySinh = dangKy.NgaySinh;
            khachHang.GioiTinh = dangKy.GioiTinh;
            khachHang.TrongCuaHang = false;
            khachHang.DiaChi = dangKy.DiaChi;
            ...
            taiKhoan.TenDangNhap = dangKy.TenDN;
            taiKhoan.MatKhau = dangKy.MatKhau;
