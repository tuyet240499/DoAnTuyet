...
namespace BanHangAPI1.Controllers
{
    public class KhachHangController : ApiController
    {
        ...
        public HttpResponseMessage Checkin(int maKH)
        {
            ...
            {
                return Request.CreateResponse(HttpStatusCode.OK, "Checkin thành công");
        ...
        [HttpPost]
        public HttpResponseMessage DangKy(string hoTen, string SDT, bool gioiTinh, string tenDangNhap, string matKhau)
        {
            bool result= khachHang.Dangky(hoTen, SDT, gioiTinh, tenDangNhap, matKhau);
            if(result==false)
            {
                return Request.CreateResponse(HttpStatusCode.BadRequest, "Có lỗi xảy ra!");
            }
        ...
        [HttpPost]
        public HttpResponseMessage BoSungThongTin(int maKH, string diaChi, string ngaySinh, string anhKH)
        {
            bool result = khachHang.BoSungThongTin(maKH, diaChi, ngaySinh, anhKH);
            if (result == false)
            {
                return Request.CreateResponse(HttpStatusCode.BadRequest, "Có lỗi xảy ra!");
            }
            ...
            {
                return Request.CreateResponse(HttpStatusCode.OK, "Cập nhập thông tin thành công");
